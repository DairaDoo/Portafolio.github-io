...
const translations = {
    en: {
        ...
        "hero-description": "Fourth-year Computer Science student and Programming Tutor at Interamerican University of Puerto Rico, Arecibo Campus, with strong expertise in student support, web development, and full-stack programming. Skilled in cloud technologies, including AWS, and passionate about mentoring, problem-solving, and leveraging technology for innovative solutions.",
        "about-title": "Meet Dairan S. De Jesús Mora",
        "about-text": "Fourth-year Computer Science student at the Interamerican University of Puerto Rico, Arecibo, with experience as a Student Support Technician and Computer Tutor. I am an AWS Certified Cloud Practitioner and hold certifications in Scrum Foundation and Software Engineering Fundamentals. I have successfully completed a Full Stack Development bootcamp, gaining hands-on experience in web development, SQL databases, and cloud technologies. Passionate about teaching, problem-solving, and continuous learning, I am committed to expanding my expertise and making meaningful contributions to technology and education.",
    ...
    es: {
        ...
        "hero-description": "Estudiante de cuarto año de Ciencias de la Computadoras y Tutor de Programación en la Universidad Interamericana de Puerto Rico, Recinto de Arecibo, con amplia experiencia en apoyo estudiantil, desarrollo web y programación full-stack. Con conocimientos en tecnologías en la nube, incluyendo AWS, y apasionado por la mentoría, la resolución de problemas y la aplicación de la tecnología para crear soluciones innovadoras.",
        "about-title": "Conoce a Dairan S. De Jesús Mora",
        "about-text": "Estudiante de cuarto año de Ciencias de Computadoras en la Universidad Interamericana de Puerto Rico, Recinto de Arecibo, con experiencia como Técnico de Soporte Estudiantil y Tutor de Computación. Soy AWS Certified Cloud Practitioner y cuento con certificaciones en Scrum Foundation y Fundamentos de Ingeniería de Software. Completé un bootcamp de Desarrollo Full Stack, adquiriendo experiencia práctica en desarrollo web, bases de datos SQL y tecnologías en la nube. Apasionado por la enseñanza, la resolución de problemas y el aprendizaje continuo, estoy comprometido con el crecimiento en mi campo y con aportar de manera significativa a la tecnología y la educación.",
