...
const translations = {
    en: {
        ...
        "hero-description": "Computer Science student at the Interamerican University of Puerto Rico, passionate about technology, innovation, and continuous learning. Experienced in full stack development, cloud computing, and recognized for my dedication as a Programming Tutor. Skilled in modern frameworks, cloud infrastructure, and agile methodologies. Eager to contribute and grow in dynamic environments.",
        "about-title": "Meet Dairan S. De Jesús Mora",
        "about-text": "I am a Computer Science student at the Interamerican University of Puerto Rico, Arecibo. I have strong experience as a Student Support Technician and Programming Tutor, where I was recognized for three years of service. I hold certifications in Scrum, Software Engineering, Full Stack Development, and AWS Cloud. I have completed a rigorous Full Stack Development bootcamp, collaborated on e-commerce projects, and have hands-on experience with SaaS, PaaS, and IaaS models. My technical skills include Python, Java, C++, C#, JavaScript, Typescript, PHP, Dart, and frameworks such as React, NestJs, NextJS, Angular, and more. I am committed to continuous learning and making a positive impact through technology.",
    ...
    es: {
        ...
        "hero-description": "Estudiante de Ciencias de Computadoras en la Universidad Interamericana de Puerto Rico, apasionado por la tecnología, la innovación y el aprendizaje continuo. Experiencia en desarrollo full stack, computación en la nube y reconocido por mi dedicación como Tutor de Programación. Habilidades en frameworks modernos, infraestructura cloud y metodologías ágiles. Listo para aportar y crecer en entornos dinámicos.",
        "about-title": "Conoce a Dairan S. De Jesús Mora",
        "about-text": "Soy estudiante de Ciencias de Computadoras en la Universidad Interamericana de Puerto Rico, Recinto de Arecibo. Tengo sólida experiencia como Técnico de Soporte Estudiantil y Tutor de Programación, donde fui reconocido por tres años de servicio. Poseo certificaciones en Scrum, Ingeniería de Software, Full Stack Development y AWS Cloud. Completé un bootcamp intensivo de desarrollo full stack, colaboré en proyectos de e-commerce y tengo experiencia práctica con modelos SaaS, PaaS e IaaS. Mis habilidades técnicas incluyen Python, Java, C++, C#, JavaScript, Typescript, PHP, Dart y frameworks como React, NestJs, NextJS, Angular y más. Comprometido con el aprendizaje continuo y el impacto positivo a través de la tecnología.",
